...
<div class="content">
    ...
    <form action="action.php" method="post" >
        <?php if(!empty($msg)): ?>
            <div style="padding: 20px; margin-top: 10px; text-align: center; color: red; border-radius: 10px; border: 2px solid red" >
                <?= $msg ?>
            </div>
        <?php endif; ?>
        ...
        <div style="display: flex; justify-content: space-between; align-items: stretch;">
            <table class="col-6">
                <tr>
                    <td><input type="radio" name="opcao" id="r1" value="2via" <?= isset($data["opcao"]) && $data['opcao'] == '2via' ? 'checked' : '' ?> ></td>
                    <td><label for="r1">2º Via (especificar)</label></td>
                    <td>CAA</td>
                </tr>
                <tr>
                    <td><input type="radio" name="opcao" id="r2"  value="aproveitamento" <?= isset($data["opcao"]) && $data['opcao'] == 'aproveitamento' ? 'checked' : '' ?> ></td>
                ...
                <tr>
                    <td><input type="radio" name="opcao" id="r3" value="matricula" <?= isset($data["opcao"]) && $data['opcao'] == 'matricula' ? 'checked' : '' ?> ></td>
                    <td><label for="r3">Matrícula fora do prazo (justificar)</label></td>
                    <td>CAA</td>
                </tr>
                <tr>
                    <td><input type="radio" name="opcao" id="r4" value="cancelamento" <?= isset($data["opcao"]) && $data['opcao'] == 'cancelamento' ? 'checked' : '' ?> ></td>
                    <td><label for="r4">Cancelamento da Matrícula</label></td>
                    <td>CAA</td>
                </tr>
                <tr>
                    <td><input type="radio" name="opcao" id="r5" value="colcacao" <?= isset($data["opcao"]) && $data['opcao'] == 'colcacao' ? 'checked' : '' ?> ></td>
                    <td><label for="r5">Colação de Grau / Colação Especial
                            (justificar)</label></td>
                    <td>CAA</td>
                </tr>
                <tr>
                    <td><input type="radio" name="opcao" id="r6" value="declaracao" <?= isset($data["opcao"]) && $data['opcao'] == 'declaracao' ? 'checked' : '' ?> ></td>
                    <td><label for="r6">Declaração (especificar)</label></td>
                    <td>CAA</td>
                </tr>
                <tr>
                    <td><input type="radio" name="opcao" id="r7" value="diploma" <?= isset($data["opcao"]) && $data['opcao'] == 'diploma' ? 'checked' : '' ?> ></td>
                    <td><label for="r7">Diploma (especificar)</label></td>
                    <td>CAA</td>
                </tr>
                <tr>
                    <td><input type="radio" name="opcao" id="r8" value="escolar" <?= isset($data["opcao"]) && $data['opcao'] == 'escolar' ? 'checked' : '' ?> ></td>
                    <td><label for="r8">Histórico Escolar</label></td>
                    <td>CAA</td>
                </tr>
                <tr>
                    <td><input type="radio" name="opcao" id="r9" value="reabertura" <?= isset($data["opcao"]) && $data['opcao'] == 'reabertura' ? 'checked' : '' ?> ></td>
                    <td><label for="r9">Reabertura de Matrícula</label></td>
                    <td>CAA</td>
                </tr>
                <tr>
                    <td><input type="radio" name="opcao" id="r10" value="segunda" <?= isset($data["opcao"]) && $data['opcao'] == 'segunda' ? 'checked' : '' ?> ></td>
                ...
                <tr>
                    <td><input type="radio" name="opcao" id="r11" value="reingresso" <?= isset($data["opcao"]) && $data['opcao'] == 'reingresso' ? 'checked' : '' ?> ></td>
            ...
            <table class="col-6">
                <tr>
                    <td><input type="radio" name="opcao" id="r12" value="trancamento" <?= isset($data["opcao"]) && $data['opcao'] == 'trancamento' ? 'checked' : '' ?> ></td>
                    <td><label for="r12">Trancamento de Disciplina (especificar)</label></td>
                    <td>Coordenação dos Cursos</td>
                </tr>
                <tr>
                    <td><input type="radio" name="opcao" id="r13"value="trancamentod" <?= isset($data["opcao"]) && $data['opcao'] == 'trancamentod' ? 'checked' : '' ?> ></td>
                ...
                <tr>
                    <td><input type="radio" name="opcao" id="r14" value="trancamento" <?= isset($data["opcao"]) && $data['opcao'] == 'trancamento' ? 'checked' : '' ?> ></td>
                    <td><label for="r14">Transferência para outra instituição</label></td>
                    <td>CAA</td>
                </tr>
                <tr>
                    <td><input type="radio" name="opcao" id="r15" value="validacao" <?= isset($data["opcao"]) && $data['opcao'] == 'validacao' ? 'checked' : '' ?> ></td>
                    <td><label for="r15">Validação de Conhecimento
                            (especificar)</label></td>
                    <td>Coordenação do Cursos</td>
                </tr>
                <tr>
                    <td><input type="radio" name="opcao" id="r16" value="reajuste" <?= isset($data["opcao"]) && $data['opcao'] == 'reajuste' ? 'checked' : '' ?> ></td>
                    <td><label for="r16">Reajuste</label></td>
                    <td>CAA</td>
                </tr>
                <tr>
                    <td><input type="radio" name="opcao" id="r17" value="prova" <?= isset($data["opcao"]) && $data['opcao'] == 'prova' ? 'checked' : '' ?> ></td>
                    <td><label for="r17">Recorreção de Prova</label></td>
                    <td>Coordenação do Cursos</td>
                </tr>
                <tr>
                    <td><input type="radio" name="opcao" id="r18" value="transporte" <?= isset($data["opcao"]) && $data['opcao'] == 'transporte' ? 'checked' : '' ?> ></td>
                    <td><label for="r18">AUXÍLIO - Transporte</label></td>
                    <td>Serviço Social</td>
                </tr>
                <tr>
                    <td><input type="radio" name="opcao" id="r19" value="moradia" <?= isset($data["opcao"]) && $data['opcao'] == 'moradia' ? 'checked' : '' ?> ></td>
                    <td><label for="r19">AUXÍLIO - Moradia</label></td>
                    <td>Serviço Social</td>
                </tr>
                <tr>
                    <td><input type="radio" name="opcao" id="r20" value="oculos" <?= isset($data["opcao"]) && $data['opcao'] == 'oculos' ? 'checked' : '' ?> ></td>
                    <td><label for="r20">AUXÍLIO - Óculos</label></td>
                    <td>Serviço Social</td>
                </tr>
                <tr>
                    <td><input type="radio" name="opcao" id="r21" value="paimae" <?= isset($data["opcao"]) && $data['opcao'] == 'paimae' ? 'checked' : '' ?> ></td>
                    <td><label for="21">AUXÍLIO - Pais e Mães</label></td>
                    <td>Serviço Social</td>
                </tr>
                <tr>
                    <td><input type="radio" name="opcao" id="r22" value="outros" <?= isset($data["opcao"]) && $data['opcao'] == 'outros' ? 'checked' : '' ?> ></td>
        ...
        <div style="display: flex; justify-content: space-between">
            <div class="col-6" style="text-align: center">
                <div>
                    ...
                    <p>
                        <input type="radio" name="ch_v" id="chv1" value="n" style="width: auto" <?= isset($data["ch_v"]) && $data['ch_v'] == 'n' ? 'checked' : '' ?> >
                        <label for="chv1">O requerente NÃO deve chave de armário</label>
                    </p>
                    <p>
                        <input type="radio" name="ch_v" id="chv2" value="s" style="width: auto" <?= isset($data["ch_v"]) && $data['ch_v'] == 's' ? 'checked' : '' ?>>
            ...
            <div class="col-6" style="text-align: center">
                <div>
                    ...
                    <p>
                        <input type="radio" name="ch_b" id="chv3" value="n" style="width: auto" <?= isset($data["ch_b"]) && $data['ch_b'] == 'n' ? 'checked' : '' ?> >
                        <label for="chv3">O requerente NÃO deve livros na biblioteca</label>
                    </p>
                    <p>
                        <input type="radio" name="ch_b" id="chv4" value="s" style="width: auto" <?= isset($data["ch_b"]) && $data['ch_b'] == 's' ? 'checked' : '' ?>>
